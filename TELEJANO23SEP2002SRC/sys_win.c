...
//#define MAXIMUM_WIN_MEMORY		0x2000000	// Tomaz - Bigger Heapsize
#define MAXIMUM_WIN_MEMORY		0x3000000  //Tei more memory, lowered to 3 from 4
...
//static char			*tracking_tag = "Clams & Mooses";//Tei commend strange stuff
...
#else
#define	MAX_HANDLES		30//10 - nehara bug 
#endif 
...
// 1 microsecond resolution
	...
	{
		Sys_Error ("Telejano requires at least Win95 or NT 4.0");
	}
