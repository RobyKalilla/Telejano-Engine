...
#include <windows.h>	// Tomaz - Copy & Paste
...
#define		MAXCMDLINE	256  //256
char		key_lines[32][MAXCMDLINE];
int			key_linepos;
int			shift_down=false;
int			key_lastpress;

int			key_insert;	// Tomaz - Enhanced Console Editing
...
{
	// Tomaz - Copy & Paste Begin
	char	*cmd, *clipText, *textCopied;
	int		i;	
	HANDLE	th;	
	// Tomaz - Copy & Paste End
	...
	if (key == K_ENTER)
	{
		...
		key_lines[edit_line][1] = 0;	// Tomaz - Enhanced Console Editing
		key_linepos = 1;
...
char chat_buffer[256];//Tei more buffer
