...
#define svc_movelmp			43		// Tei - move lmp pos
#define svc_updatelmp		44		// Tei - update lmp file

#define	svc_spawnstatic2		45	//Tei extra sps
...
#define TE_ALIENEXPLOSION	22  // Tei alien explosion
